  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a style="background-color:#EEEEEE;color:black;" href="AdminC.php">Customer</a></li>
    ...
    <form method="post" action="../controllers/CRUD.php">
       ...
       <h3>Edit Customer</h3>
        ...
        <button type="submit" name="submitC" style="background-color:#45a049; color: white; width: 120px; height: 30px;" onclick="return confirm('Are you sure you want to Edit this record?');">Update</button>
        <button type="button" onclick="window.location.href='AdminC.php'">Cancel</button> 
<?php } ?>
    </form>
</div>
</body>
