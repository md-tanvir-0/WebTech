  ...
  <div class="row content">
    ...
    <form method="post" action="../controllers/CRUD.php">
       ...
       <h3>Edit Agent</h3>
        ...
        <button type="submit" name="submitA" style="background-color:#45a049; color: white; width: 120px; height: 30px;" onclick="return confirm('Are you sure you want to Edit this record?');">Update</button>
